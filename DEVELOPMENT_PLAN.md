...
| v0.10 — Layer 2 (CVP/offerings), first sources + 3 real bugs found and fixed | 🚧 Partial — 6 of 10 bank news/fee sources solved (BIDV news+fee, ACB promo, VPBank news+fee, VCB promo); VCB's fee page needs OCR (image-only, not a crawling problem); MBBank + ACB's fee page still open |
