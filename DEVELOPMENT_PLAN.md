...
| v0.10 — Layer 2 (CVP/offerings), first sources + 3 real bugs found and fixed | 🚧 Partial — 9 of 10 bank news/fee sources solved (BIDV news+fee, ACB promo+fee, VPBank news+fee, VCB promo, MBBank news+fee); only VCB fee remains, needs OCR (image-only) |
