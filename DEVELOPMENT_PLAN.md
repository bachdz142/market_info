...
| v0.10 — Layer 2 (CVP/offerings), first sources + 3 real bugs found and fixed | 🚧 Partial — 7 of 10 bank news/fee sources solved (BIDV news+fee, ACB promo+fee, VPBank news+fee, VCB promo); VCB fee needs OCR (image-only); MBBank blocked by design (Akamai wall, spec says don't evade) |
